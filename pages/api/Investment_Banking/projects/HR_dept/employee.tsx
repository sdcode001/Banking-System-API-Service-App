...
/** 
 * @swagger
 *  /api/Investment_Banking/projects/HR_dept/employee:
 *    post:
 *      summary: Insert an employee in HR Dept of the project mentioned under of Investment_Banking.
 *      description: this api is used to insert an employee in HR Dept of the project mentioned under of Investment_Banking to MongoDB database
 *      requestBody:
 *        content:
 *          application/json:
 *            schema:
 ...
 *  /api/Investment_Banking/projects/HR_dept/employee:
 *    get:
 *      summary: Get the list of employee in HR dept of the project mentioned under of Investment_Banking.
 *      description: Get the list of employee in HR dept of the project mentioned under of Investment_Banking from MongoDB database.
 *      parameters:
 *        - in: query
 *          name: project_name
 *          schema:
 ...
 *  /api/Investment_Banking/projects/HR_dept/employee:
 *    delete:
 *      summary: Delete an employee from HR Dept of the project mentioned under of Investment_Banking.
 *      description: this api is used to delete an employee from HR Dept of the project mentioned under of Investment_Banking in MongoDB database
 *      parameters:
 *        - in: query
 *          name: project_name
 *          schema:
