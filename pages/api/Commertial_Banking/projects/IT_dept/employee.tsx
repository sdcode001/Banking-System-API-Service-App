...
/** 
 * @swagger
 *  /api/Commertial_Banking/projects/IT_dept/employee:
 *    post:
 *      summary: Insert an employee in IT Dept of the project mentioned under of Commertial_Banking.
 *      description: this api is used to insert an employee in IT Dept of the project mentioned under of Commertial_Banking to MongoDB database
 *      requestBody:
 *        content:
 *          application/json:
 *            schema:
 ...
 *  /api/Commertial_Banking/projects/IT_dept/employee:
 *    get:
 *      summary: Get the list of employee in IT dept of the project mentioned under of Commertial_Banking.
 *      description: Get the list of employee in IT dept of the project mentioned under of Commertial_Banking from MongoDB database.
 *      parameters:
 *        - in: query
 *          name: project_name
 *          schema:
 ...
 *  /api/Commertial_Banking/projects/IT_dept/employee:
 *    delete:
 *      summary: Delete an employee from IT Dept of the project mentioned under of Commertial_Banking.
 *      description: this api is used to delete an employee from IT Dept of the project mentioned under of Commertial_Banking in MongoDB database
 *      parameters:
 *        - in: query
 *          name: project_name
 *          schema:
