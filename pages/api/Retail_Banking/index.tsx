 ...
 * /api/Retail_Banking:
 *   get:
 *     summary: List of Projects in Retail banking
 *     description: Returns the list of all projects under Retail banking from MongoDB database
 *     responses:
 *       '200':
 *          content: 
 *            application/json:
 ...
 *          description: List of project under Retail banking from MongoDB database
 */
if(req.method=='GET'){
  ...
  const db=client.db()
  const result=await db.collection('Retail_banking').find().toArray()
  client.close()
